...
dependencies {
        ...
  ksp("com.github.anton-novikau:boringyuri-dagger-ksp:2.2.2")
}
```
...
dependencies {
        ...
  kapt("com.github.anton-novikau:boringyuri-dagger:2.2.2")
}
```
...
dependencies {
         ...
  annotationProcessor "com.github.anton-novikau:boringyuri-dagger:2.2.2"
}
```
