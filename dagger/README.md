...
dependencies {
        ...
  ksp("com.github.anton-novikau:boringyuri-dagger-ksp:2.2.1")
}
```
...
dependencies {
        ...
  kapt("com.github.anton-novikau:boringyuri-dagger:2.2.1")
}
```
...
dependencies {
         ...
  annotationProcessor "com.github.anton-novikau:boringyuri-dagger:2.2.1"
}
```
