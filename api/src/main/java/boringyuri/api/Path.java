 ...
 * An order of the method parameters annotated with <code>&#64Path</code> is important as
 * it defines the order of the path segments. Example:
 * </p>
 * <pre><code>
 *     &#64UriBuilder("user")
 *     public Uri buildFetchUserDetailsUri(&#64Path String group, &#64Path long userId);
 * </code></pre>
 ...
 * <pre><code>
 *    &#64UriBuilder("user")
 *    Uri buildEncodedUri(&#64Path String name);
 *
 *    &#64UriBuilder("user")
 *    Uri buildNotEncoded(&#64Path, encoded=true) String name);
 * </code></pre>
 ...
 * </p>
 * <p>
 * When a method of a {@code Uri} data class is annotated with <code>&#64Path</code> it
