...
dependencies {
        ...
  ksp("com.github.anton-novikau:boringyuri-dagger-ksp:2.2.0")
}
```
...
dependencies {
        ...
  kapt("com.github.anton-novikau:boringyuri-dagger:2.2.0")
}
```
...
dependencies {
         ...
  annotationProcessor "com.github.anton-novikau:boringyuri-dagger:2.2.0"
}
```
